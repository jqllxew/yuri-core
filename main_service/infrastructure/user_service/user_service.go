...
func (u *UserServiceImpl) Login(ctx context.Context, username, password string) (*user.UserInfo, int8) {
	...
	verbose.DebugPrintf(2, "Call Login req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call Login resp=%+v", resp)
...
func (u *UserServiceImpl) Register(ctx context.Context, username, password string) (bool, error) {
	...
	verbose.DebugPrintf(2, "Call Register req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call Register resp=%+v", resp)
...
func (u *UserServiceImpl) GetUserInfo(ctx context.Context, userID uint32) (*user.UserInfo, error) {
	...
	verbose.DebugPrintf(2, "Call GetUserInfo req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call GetUserInfo resp=%+v", resp)
...
func (u *UserServiceImpl) UserDown(ctx context.Context, userID uint32) (bool, error) {
	...
	verbose.DebugPrintf(2, "Call UserDown req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call UserDown resp=%+v", resp)
...
func (u *UserServiceImpl) UpdateBag(ctx context.Context, UserID uint32, BagID uint16, Slot uint8, ItemID uint16) (*user.UserInfo, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateBag req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call UpdateBag resp=%+v", resp)
...
func (u *UserServiceImpl) UpdateBuymenu(ctx context.Context, UserID uint32, BuymenuID uint16, Slot uint8, ItemID uint16) (*user.UserInfo, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateBuymenu req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call UpdateBuymenu resp=%+v", resp)
...
func (u *UserServiceImpl) UpdateCosmetics(ctx context.Context, UserID uint32, CosmeticsID uint8, cosmetics *user.UserCosmetics) (*user.UserInfo, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateCosmetics req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call UpdateCosmetics resp=%+v", resp)
...
func (u *UserServiceImpl) UpdateCampaign(ctx context.Context, UserID uint32, CampaignID uint8) (*user.UserInfo, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateCampaign req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call UpdateCampaign resp=%+v", resp)
...
func (u *UserServiceImpl) UpdateOptions(ctx context.Context, UserID uint32, options []byte) (*user.UserInfo, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateOptions req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call UpdateOptions resp=%+v", resp)
...
func (u *UserServiceImpl) UpdateNickname(ctx context.Context, UserID uint32, nickname string) (*user.UserInfo, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateNickname req=%+v", req)
	u.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call UpdateNickname resp=%+v", resp)
