...
func (r *RoomServiceImpl) GetServiceList(ctx context.Context) ([]server.Server, error) {
	...
	verbose.DebugPrintf(2, "Call GetServiceList req=%+v", req)
	r.lock.Lock()
	...
	verbose.DebugPrintf(2, "Call GetServiceList resp=%+v", resp)
...
func (r *RoomServiceImpl) GetRoomList(ctx context.Context, ServerIndex, ChannelIndex uint8) ([]server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call GetRoomList req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call GetRoomList resp=%+v", resp)
...
func (r *RoomServiceImpl) NewRoom(ctx context.Context, room *server.Room) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call NewRoom req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call NewRoom resp=%+v", resp)
...
func (r *RoomServiceImpl) UpdateRoom(ctx context.Context, room *server.Room) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateRoom req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call UpdateRoom resp=%+v", resp)
...
func (r *RoomServiceImpl) JoinRoom(ctx context.Context, userID uint32, roomID uint16) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call JoinRoom req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call JoinRoom resp=%+v", resp)
...
func (r *RoomServiceImpl) LeaveRoom(ctx context.Context, userID uint32, roomID uint16) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call LeaveRoom req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call LeaveRoom resp=%+v", resp)
...
func (r *RoomServiceImpl) StartGame(ctx context.Context, userID uint32, roomID uint16) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call StartGame req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call StartGame resp=%+v", resp)
...
func (r *RoomServiceImpl) GetRoomInfo(ctx context.Context, roomID uint16) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call GetRoomInfo req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call GetRoomInfo resp=%+v", resp)
...
func (r *RoomServiceImpl) UpdateRoomSafe(ctx context.Context, room *server.Room) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call UpdateRoomSafe req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call UpdateRoomSafe resp=%+v", resp)
...
func (r *RoomServiceImpl) SetRoomHost(ctx context.Context, userID uint32, name string, roomID uint16) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call SetRoomHost req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call SetRoomHost resp=%+v", resp)
...
func (r *RoomServiceImpl) DelRoom(ctx context.Context, roomID uint16) error {
	...
	verbose.DebugPrintf(2, "Call DelRoom req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call DelRoom resp=%+v", resp)
...
func (r *RoomServiceImpl) EndGame(ctx context.Context, userID uint32, roomID uint16) (*server.Room, error) {
	...
	verbose.DebugPrintf(2, "Call EndGame req=%+v", req)
	...
	verbose.DebugPrintf(2, "Call EndGame resp=%+v", resp)
